...
class Database {
    ...
    public static function getConnection(): Connection {
        if (self::$instance === null) {
            ...
            // Performance optimization: use persistent connections for SQLite
            ...
            // Enable foreign keys and performance optimizations for SQLite (only once)
            if (!self::$initialized && $config['driver'] === 'pdo_sqlite') {
                ...
                self::$instance->executeStatement("PRAGMA cache_size = -64000"); // 64MB cache
