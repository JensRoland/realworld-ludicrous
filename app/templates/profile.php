        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-md-10 offset-md-1">
                    <img src="<?= $profile['image'] ?: '/img/smiley-cyrus.avif' ?>" class="user-img" alt="author avatar" />
                    <h4><?= htmlspecialchars($profile['username']) ?></h4>
                    <p><?= htmlspecialchars($profile['bio'] ?? '') ?></p>

                    <?php if (\App\Lib\Auth::check() && \App\Lib\Auth::userId() == $profile['id']): ?>
                    ...
                    <?php elseif (\App\Lib\Auth::check()): ?>
                        <?php \App\Components\FollowButton\render($profile, $isFollowing); ?>
                    <?php else: ?>
