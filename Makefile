...
setup: install
	...
	php database/migrations.php migrations:migrate --no-interaction
...
migrate-status:
	php database/migrations.php migrations:status

migrate-generate:
	php database/migrations.php migrations:generate
